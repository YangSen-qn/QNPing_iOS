...
@protocol QNSimplePingDelegate;

/*! Controls the IP address version used by SimplePing instances.
 */

typedef NS_ENUM(NSInteger, QNSimplePingAddressStyle) {
    QNSimplePingAddressStyleAny,          ///< Use the first IPv4 or IPv6 address found; the default.
    QNSimplePingAddressStyleICMPv4,       ///< Use the first IPv4 address found.
    QNSimplePingAddressStyleICMPv6        ///< Use the first IPv6 address found.
};
...
@interface QNSimplePing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<QNSimplePingDelegate> delegate;

/*! Controls the IP address version used by the object.
 *  \details You should set this value before starting the object.
 */

@property (nonatomic, assign, readwrite) QNSimplePingAddressStyle addressStyle;
...
@protocol QNSimplePingDelegate <NSObject>
